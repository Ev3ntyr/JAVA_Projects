...
INSERT INTO SOLD_ITEMS (nameItem, descriptionItem, bidStartDate, bidEndDate, initialPrice, sellingPrice, stateItem, idUser, idCategory)
VALUES
    ('Canap� en Cuir', 'Un canape en cuir veritable pleine fleur de couleur beige. 6 places assises, tres confortable, legerement abime', '2023-09-04', '2023-09-20', 500, NULL, 1, 1, 2),
    ('Table � Manger', 'Une table � manger en bois massif', '2023-09-05', '2023-09-19', 200, NULL, 1, 4, 2);

-- Adding sports items
INSERT INTO SOLD_ITEMS (nameItem, descriptionItem, bidStartDate, bidEndDate, initialPrice, sellingPrice, stateItem, idUser, idCategory)
VALUES
    ('V�lo de Montagne', 'Un velo de montagne tout-terrain qui roule super bien et a des gros pneus. 16 vitesses, sonette et antivol compris', '2023-06-07', '2023-06-22', 350, 370, 2, 4, 3),
...
INSERT INTO SOLD_ITEMS (nameItem, descriptionItem, bidStartDate, bidEndDate, initialPrice, sellingPrice, stateItem, idUser, idCategory)
VALUES
    ('Manteau Hiver T38 Kaporal', 'Un manteau hiver chaud et �l�gant pour homme', '2023-09-01', '2023-09-26', 30, NULL, 1, 4, 4);
