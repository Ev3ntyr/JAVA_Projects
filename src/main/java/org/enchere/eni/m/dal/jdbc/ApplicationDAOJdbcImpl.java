...
//			END;
	...
	public void initDataset() {
		...
		Item i = new Item();
		Item i2 = new Item("Ordinateur Portable AlienWare", "Un ordinateur portable haut de gamme AlienWare avec 32 GO de RAM !!", LocalDateTime.of(LocalDate.of(2023, 9, 4), LocalTime.of(10, 39)), LocalDateTime.of(LocalDate.of(2023, 9, 16), LocalTime.of(10, 39)), 600, 600, 1, u1, c1);
		Item i3 = new Item("Tablette Android", "Une tablette Android de derniere generation de 10 pouces, pas de chargeur cependant, prevoir de racheter", LocalDateTime.of(LocalDate.of(2023, 9, 10), LocalTime.of(11, 34)), LocalDateTime.of(LocalDate.of(2023, 9, 18), LocalTime.of(9, 34)), 320, 320, 1, u1, c1);
		Item i4 = new Item("Imprimante Laser Canon", "Une imprimante laser rapide et silencieuse", LocalDateTime.of(LocalDate.of(2023, 8, 1), LocalTime.of(15, 0)), LocalDateTime.of(LocalDate.of(2023, 8, 20), LocalTime.of(10, 39)), 150, 223, 2, u3, c1);
		Item i5 = new Item("Moniteur 27 pouces Dell", "Un moniteur IPS de 27 pouces de la marque DELL, TBE", LocalDateTime.of(LocalDate.of(2023, 9, 17), LocalTime.of(12, 0)), LocalDateTime.of(LocalDate.of(2023, 9, 22), LocalTime.of(12, 0)), 250, 250, 2, u2, c1);
		
		Item i6 = new Item("Canapé en Cuir", "Un canape en cuir veritable pleine fleur de couleur beige. 6 places assises, tres confortable, legerement abime", LocalDateTime.of(LocalDate.of(2023, 9, 4), LocalTime.of(9, 30)), LocalDateTime.of(LocalDate.of(2023, 9, 20), LocalTime.of(16, 0)), 500, 500, 1, u1, c2);
		Item i7 = new Item("Table à Manger", "Une table à manger en bois massif", LocalDateTime.of(LocalDate.of(2023, 9, 5), LocalTime.of(14, 30)), LocalDateTime.of(LocalDate.of(2023, 9, 19), LocalTime.of(14, 30)), 200, 200, 1, u4, c2);
		
		Item i8 = new Item("Vélo de Montagne", "Un velo de montagne tout-terrain qui roule super bien et a des gros pneus. 16 vitesses, sonette et antivol compris", LocalDateTime.of(LocalDate.of(2023, 6, 7), LocalTime.of(21, 30)), LocalDateTime.of(LocalDate.of(2023, 6, 22), LocalTime.of(22, 0)), 350, 370, 0, u4, c3);
		Item i9 = new Item("Raquette de Tennis Decathlon", "Une raquette de tennis professionnelle pour les enfants", LocalDateTime.of(LocalDate.of(2023, 9, 19), LocalTime.of(17, 30)), LocalDateTime.of(LocalDate.of(2023, 9, 23), LocalTime.of(9, 0)), 100, 100, 0, u3, c3);
		
		Item i10 = new Item("Manteau Hiver T38 Kaporal", "Un manteau hiver chaud et élégant pour homme", LocalDateTime.of(LocalDate.of(2023, 9, 1), LocalTime.of(10, 0)), LocalDateTime.of(LocalDate.of(2023, 9, 26), LocalTime.of(10, 0)), 30, 30, 1, u4, c4);
